...
Use regression to predict sales for Vendor 'A' based on a particular theme.
...
- First start a mlflow server by running the following command:
    ```
    (ta-lib-dev):~/<proj-folder>$ mlflow ui
    ```
